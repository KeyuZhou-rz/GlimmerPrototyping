...
> **批注（2026-07-31 销案）**：B2/B3（恢复起伏/台地断崖收紧）已被"保持地形粗粝、TerrainGenerator 禁改"决策取代（见 `Docs/Demo2TerrainDetail.md`），不再执行；D 节水面调色随 2026-07-28 拍板 C5"水面反射撤出"一并挂起。本文档仅余 B4 高度带脱钩修复一项开放（隐患级，非阻塞）。
